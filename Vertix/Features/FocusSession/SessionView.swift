...
struct SessionView: View {
    ...
    private var pomodoroCard: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: 6) {
                Circle()
                    .fill(Color(viewModel.phaseColor))
                    .frame(width: 8, height: 8)
                Text(viewModel.phaseLabel)
                    .font(.system(size: 11, weight: .semibold))
                    .foregroundColor(Color(viewModel.phaseColor))
                    .tracking(1.2)
                Spacer()
                ...
                Button(action: { showSettings = true }) {
                    Image(systemName: "slider.horizontal.3")
                        ...
                        .background(Color("6B6B6B").opacity(0.08))
                        .clipShape(Circle())
                }
            }
            ...
            HStack(spacing: 32) {
                ...
                ZStack {
                    Circle()
                        .stroke(Color("2D5A3D").opacity(0.1), lineWidth: 8)
                    ...
                    HStack(spacing: 16) {
                        ...
                        Button(action: { viewModel.resetTimer() }) {
                            Image(systemName: "arrow.counterclockwise")
                                ...
                                .background(Color("6B6B6B").opacity(0.1))
                                .clipShape(Circle())
                        }
...
struct SpineBarRow: View {
    ...
    private var barColor: Color {
        value >= 80 ? Color("2D5A3D") : Color("E05A3A")
    }

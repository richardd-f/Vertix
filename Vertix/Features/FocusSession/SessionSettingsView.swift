            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 0) {
                    ForEach(0..<cyclesBeforeLongBreak, id: \.self) { index in
                        HStack(spacing: 0) {
                            ...
                            Text("\(focusDuration)m")
                                ...
                                .padding(.vertical, 6)
                                .background(Color("2D5A3D").opacity(0.12))
                                .cornerRadius(6)
                            ...
                            if index < cyclesBeforeLongBreak - 1 {
                                ...
                                Text("\(shortBreakDuration)m")
                                    .font(.system(size: 11, weight: .semibold))
                                    .foregroundColor(Color("3A7CA5"))
                                    .padding(.horizontal, 10)
                                    .padding(.vertical, 6)
                                    .background(Color("3A7CA5").opacity(0.12))
                                    .cornerRadius(6)
                    ...
                    Text("\(longBreakDuration)m")
                        .font(.system(size: 11, weight: .semibold))
                        .foregroundColor(Color("7B4EA6"))
                        .padding(.horizontal, 10)
                        .padding(.vertical, 6)
                        .background(Color("7B4EA6").opacity(0.12))
                        .cornerRadius(6)
                }
